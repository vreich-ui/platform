...
| S4 (cont.)  | Marginalia follow-up, items 9–16 (selected-text span anchoring, reply-threading UI, gutter badges/dot counters, image-ref-specific comments, notifications/digests, per-role comment-visibility policy, review-decision linking, headless-browser smoke test) | **Scheduled as W17** (see `17-canvas-ux-plan.md`). Item 11 (gutter badges/dot counters) is **DONE** — landed 2026-08-10 as T17.6, together with the concept's global `Attention N` counter; the rest are queued rows T17.4/T17.5/T17.9/T17.10/T17.11/T17.12/T17.13 | —                                                                                                                                                                      |
...
- [x] **Decide on the S4 continuation** (items 9–16) — DONE: Wolf's 2026-08-10 canvas-UX ruling took the full concept, and the items are now W17 queue rows. Item 11 (gutter badges) shipped with T17.6 on 2026-08-10; the others are scheduled, not yet run.
