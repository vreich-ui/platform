...
> **Status:** first verified against commit `6789644` (2026-09-05); correction pass verified against `420afbd` (2026-09-06). This file is the entry point for an AI agent. It tells you where truth lives, what to ignore, and which document to open next. Root `AGENTS.md` / `CLAUDE.md` carry the *rules*; this file carries the *map*.
