/**
 * Baseline navigation SKELETON for 'site_genesis_lab_3' (T11.7 create-site
 ...
 *   --site sites/genesis-lab-3 --seeds sites/genesis-lab-3/seeds/navigation-seed-data.mjs
 */
