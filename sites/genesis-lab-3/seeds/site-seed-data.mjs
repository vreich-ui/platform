/**
 * Baseline site-singleton seed for 'site_genesis_lab_3' (T11.7 create-site
 ...
 *   --site sites/genesis-lab-3 --seeds sites/genesis-lab-3/seeds/site-seed-data.mjs
 */
...
export const siteBody = {
  ...
  urls: {
    base: '/',
    canonicalHost: 'https://kugel-genesis-lab-3.netlify.app',
  },
  metadataDefaults: {
    description: 'Genesis Lab 3 — a starter site, ready for real content.',
    ogImage: '/Social/og-default.jpg',
    titleTemplate: '%s - Genesis Lab 3',
  },
  brandTokens: {
    colors: {
...
export const visualStandardBody = {
  "version": 1,
  "kind": "house",
  "label": "Genesis Lab 3 — house visual standard",
  "description": "The default image style for Genesis Lab 3, derived automatically from its brand palette (brandTokens) rather than hand-authored. Replace with a client-specific mood board and writer proposal once real brand direction exists.",
  "brandImagery": {
    "version": 1,
    "medium": "digital_illustration",
    "styleSentence": "Cool editorial digital illustration on a clean off-white ground, built around confident blue and muted teal accents; matte textured shapes with softly rounded forms, balanced negative space, soft diffuse light and no harsh shadows; clear, modern editorial feel with a deliberately limited palette.",
  ...
  "references": [],
  "sampleSubjects": [
    "a person in a senior and aging pets — mobility, comfort, everyday care setting, an everyday moment",
    "a close-up of hands at work in senior and aging pets — mobility, comfort, everyday care",
    "a quiet still-life of objects related to senior and aging pets — mobility, comfort, everyday care"
  ],
  "derivedFrom": {
    "method": "tokens"
  },
...
export const CONVERSION_SEEDS = [
  { objectType: 'site', objectId: 'site_genesis_lab_3', body: siteBody },
  { objectType: 'visual_standard', objectId: 'vis_genesis_lab_3', body: visualStandardBody },
];
