/**
 * Editorial-strategy SKELETON for 'site_genesis_lab_3' (Wolf, 2026-09-09) — the
 ...
 *   --site sites/genesis-lab-3 --seeds sites/genesis-lab-3/seeds/strategy-seed-data.mjs
 */

export const SEED_SITE = 'site_genesis_lab_3';

export const strategyBody = {
  "name": "Genesis Lab 3 — strategy (onboarding: fill with the client)",
  ...
  "private": {
    "notes": "Genesis was told this tenant publishes about: senior and aging pets — mobility, comfort, everyday care."
  },
  "provenance": {
...
export const CONVERSION_SEEDS = [
  { objectType: 'editorial_strategy', objectId: 'strat_genesis_lab_3', body: strategyBody },
];
