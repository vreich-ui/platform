/**
 * Baseline taxonomy-registry SKELETON for 'tax_genesis_lab_3' (T11.7
 ...
 *   --site sites/genesis-lab-3 --seeds sites/genesis-lab-3/seeds/taxonomy-seed-data.mjs
 */
...
export const CONVERSION_SEEDS = [{ objectType: 'taxonomy', objectId: 'tax_genesis_lab_3', body: taxonomyBody }];
