/**
 * Baseline default THEME for 'thm_genesis_lab_3_default' (T11.7 create-site scaffold).
 ...
 *   --site sites/genesis-lab-3 --seeds sites/genesis-lab-3/seeds/themes-seed-data.mjs
 */
...
export const CONVERSION_SEEDS = [{ objectType: 'theme', objectId: 'thm_genesis_lab_3_default', body: themeDefaultBody }];
