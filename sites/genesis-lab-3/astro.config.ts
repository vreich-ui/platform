/**
 * genesis-lab-3's build entry — a thin entry over the shared shell in
 ...
 * aliases exist.
 *
 *   npx astro build --config sites/genesis-lab-3/astro.config.ts
 */
