/**
 * Site shim for 'site_genesis_lab_2': instantiates the core `admin-analytics` handler with
 * this site's SiteBinding. The implementation is fleet law in
 * packages/core/server/functions/admin-analytics.ts; this file is the per-site wire.
 *
