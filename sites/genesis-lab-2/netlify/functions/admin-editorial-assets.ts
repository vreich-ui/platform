/**
 * Site shim for 'site_genesis_lab_2': instantiates the core `admin-editorial-assets` handler with
 * this site's SiteBinding. The implementation is fleet law in
 * packages/core/server/functions/admin-editorial-assets.ts; this file is the per-site wire.
 *
