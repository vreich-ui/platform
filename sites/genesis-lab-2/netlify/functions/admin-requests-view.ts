/**
 * Site shim for 'site_genesis_lab_2': instantiates the core `admin-requests-view` handler with
 * this site's SiteBinding. The implementation is fleet law in
 * packages/core/server/functions/admin-requests-view.ts; this file is the per-site wire.
 *
