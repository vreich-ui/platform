/**
 * Tracking-config SKELETON for 'site_genesis_lab_2' (T16.1 create-site scaffold,
 ...
 *   --site sites/genesis-lab-2 --seeds sites/genesis-lab-2/seeds/tracking-config-seed-data.mjs
 */
...
export const CONVERSION_SEEDS = [
  { objectType: 'tracking_config', objectId: 'trk_genesis_lab_2', body: trackingConfigBody },
];
