/**
 * Editorial-strategy SKELETON for 'site_genesis_lab_2' (Wolf, 2026-09-09) — the
 ...
 *   --site sites/genesis-lab-2 --seeds sites/genesis-lab-2/seeds/strategy-seed-data.mjs
 */

export const SEED_SITE = 'site_genesis_lab_2';

export const strategyBody = {
  "name": "Genesis Lab 2 — strategy (onboarding: fill with the client)",
...
export const CONVERSION_SEEDS = [
  { objectType: 'editorial_strategy', objectId: 'strat_genesis_lab_2', body: strategyBody },
];
