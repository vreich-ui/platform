/**
 * Baseline default THEME for 'thm_genesis_lab_2_default' (T11.7 create-site scaffold).
 ...
 *   --site sites/genesis-lab-2 --seeds sites/genesis-lab-2/seeds/themes-seed-data.mjs
 */
...
export const CONVERSION_SEEDS = [{ objectType: 'theme', objectId: 'thm_genesis_lab_2_default', body: themeDefaultBody }];
