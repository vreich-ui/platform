/**
 * Editorial-strategy SKELETON for 'site_fernwell' (Wolf, 2026-09-09) — the
 ...
 *   --site sites/fernwell --seeds sites/fernwell/seeds/strategy-seed-data.mjs
 */

export const SEED_SITE = 'site_fernwell';

export const strategyBody = {
  "name": "Fernwell — strategy (onboarding: fill with the client)",
...
export const CONVERSION_SEEDS = [
  { objectType: 'editorial_strategy', objectId: 'strat_fernwell', body: strategyBody },
];
