/**
 * Editorial-strategy SKELETON for 'site_platform' (Wolf, 2026-09-09) — the
 ...
 *   --site sites/platform --seeds sites/platform/seeds/strategy-seed-data.mjs
 */

export const SEED_SITE = 'site_platform';

export const strategyBody = {
  "name": "Platform — strategy (onboarding: fill with the client)",
...
export const CONVERSION_SEEDS = [
  { objectType: 'editorial_strategy', objectId: 'strat_platform', body: strategyBody },
];
