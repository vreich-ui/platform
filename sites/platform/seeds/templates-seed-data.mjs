/**
 * Baseline starter TEMPLATE recipes for 'site_platform' (T16.1 backfill of
 * the W15 S3 follow-up to the T11.7 create-site scaffold) — the same three
 * core-provided starter page shapes every client gets (Dr-Lurie's
 * sites/drlurie/seeds/templates-seed-data.mjs, W2.5; fernwell's
 * sites/fernwell/seeds/templates-seed-data.mjs, S3): the standard interior
 ...
 *
 * Platform already carries one bespoke `template` (`tpl_object_reference`,
 * content-specific to documenting object types) — this seed adds the
 * GENERIC starter trio alongside it, not a replacement (plan §1.2 finding 3,
 * "templates half-closed": platform had no starter page-template recipes at
 * all).
 *
 * Driver contract for scripts/home-conversion-roundtrip.mjs:
 *   --site sites/platform --seeds sites/platform/seeds/templates-seed-data.mjs
 */
