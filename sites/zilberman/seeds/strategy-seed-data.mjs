/**
 * Editorial-strategy SKELETON for 'site_zilberman' (Wolf, 2026-09-09) — the
 ...
 *   --site sites/zilberman --seeds sites/zilberman/seeds/strategy-seed-data.mjs
 */

export const SEED_SITE = 'site_zilberman';

export const strategyBody = {
  "name": "Zilberman — strategy (onboarding: fill with the client)",
...
export const CONVERSION_SEEDS = [
  { objectType: 'editorial_strategy', objectId: 'strat_zilberman', body: strategyBody },
];
