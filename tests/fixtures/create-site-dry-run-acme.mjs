...
Files to create under sites/acme/ (109):
  ...
  + sites/acme/seeds/strategy-seed-data.mjs
  ...
  + sites/acme/data/site/strategy/.gitkeep
  ...
  + sites/acme/netlify/functions/admin-content-view.ts
  + sites/acme/netlify/functions/admin-editorial-assets.ts
  + sites/acme/netlify/functions/admin-editorial-view.ts
  ...
  + sites/acme/netlify/functions/admin-shell.ts
  + sites/acme/netlify/functions/admin-taxonomy.ts
  + sites/acme/netlify/functions/admin-users.ts
  + sites/acme/netlify/functions/admin-visual-identity-import.ts
  + sites/acme/netlify/functions/admin-visual-identity-preview-sample.ts
  + sites/acme/netlify/functions/admin-visual-identity-propose.ts
  + sites/acme/netlify/functions/admin-visual-identity-regenerate-examples.ts
  + sites/acme/netlify/functions/admin-visual-identity-render-sample.ts
  + sites/acme/netlify/functions/analytics-snapshot-warm.ts
  ...
  + sites/acme/netlify/functions/governance-probe-refresh.ts
  ...
  + sites/acme/netlify/functions/visual-standard-examples-background.ts
