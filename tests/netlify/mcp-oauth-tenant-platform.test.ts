/**
 * Fleet parity (P1): the whole OAuth connector flow, on the 'platform' tenant.
 *
...
import { handler as oauthHandler } from '../../sites/platform/netlify/functions/mcp-oauth.js';
import { handler as mcpHandler } from '../../sites/platform/netlify/functions/mcp.js';
import { runTenantOAuthFlow, type LambdaLikeHandler } from './tenant-oauth-flow.js';

const HOST = 'kugel-platform.netlify.app';
...
test('platform: register → authorize → consent → token → an authorized tools/list', async () => {
